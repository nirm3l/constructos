...
if [[ ! -f "$CODEX_AUTH_FILE" ]]; then
  ...
  log_info "Deploy will continue without mounting Codex auth. Authenticate later through the app UI if needed."
elif ! chmod a+r "$CODEX_AUTH_FILE" 2>/dev/null; then
